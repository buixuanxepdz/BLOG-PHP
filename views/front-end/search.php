                                    ...
                                    <div class="post-wrapper b-bottom pb-30 mb-60">
                                        <div class="post-title">
                                            <div class="transparent-tag">
                                                <span><a href="#">- <?= $search['categoryname'] ?> -</a></span>
                                            </div>
                                            <h4 class="lora-font"><a href="#"><?= $search['title'] ?></a></h4>
                                            <span><?= $search['username'] ?> - <?= date('d/m/Y', strtotime($search['created_at'])) ?></span>
                                        </div>
                                        <div class="post-thumb">
                                            <a href="#"><img src="publics/posts/<?= $search['thumbnail'] ?>" alt="Lifestyle"></a>
                                        </div>
                                        <div class="post-content lifestyle-article">
                                            <p><?= $search['content'] ?></p>
                                            <div class="post-meta border-none p-0">
                                                <a href="?admin=client&mod=home&act=detail&slug=<?= $search['slug'] ?>" class="btn transparent-btn f-left">Xem thêm</a>
